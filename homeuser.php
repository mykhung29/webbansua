...
<html lang="en">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://bizweb.dktcdn.net/100/011/344/files/whey-protein-b11d4a67-184f-4765-9ac4-76895e066309.jpg?v=1669363280625?1655096149867" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="https://wheyshop.vn/wp-content/uploads/2022/02/top-7-whey-protein-hydrolyzed-tot-nhat.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
    <img src="https://wheyshop.vn/wp-content/uploads/2022/02/top-7-whey-protein-hydrolyzed-tot-nhat.jpg" class="d-block w-100" alt="...">
    </div>
          ...
          <div class = "list-trang">
            ...
            ?>
              <ul>
                <?php 
                 for($i=1; $i<=$trang;$i++){ ?>
                <li><a href="home.php?trang=<?php echo $i?>"><?php echo $i ?></a></li>
                <?php } ?>
              </ul>
